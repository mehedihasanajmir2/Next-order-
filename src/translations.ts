...
export const TRANSLATIONS: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    ledger: "TaliKhata Ledger",
    logOut: "Log Out",
    exitDemo: "Exit Demo NextOrder",
    demoBadge: "DEMO NEXTORDER",
  ...
  bn: {
    ...
    ledger: "তালিখাতা (বাকির হিসাব)",
    logOut: "লগ আউট করুন",
    exitDemo: "ডেমো নেক্সটঅর্ডার বন্ধ করুন",
    demoBadge: "ডেমো নেক্সটঅর্ডার",
